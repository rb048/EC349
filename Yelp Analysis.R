...
user_data_small<-select(user_data_small,user_id, review_count,friends,average_stars)
business_data<-select(business_data,business_id,state,stars,review_count,is_open,categories)
review_data_small<-select(review_data_small,review_id,user_id,business_id,stars,text)
...
rm(review_stars,review_vars,review_words,user_vars,word_counts,word_scores)
#clear memory to free up space for model
